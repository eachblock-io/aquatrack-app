          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <Transition.Child
              ...
              <Dialog.Panel className="relative transform rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 w-11/12 lg:w-8/12">
                <div className="flex items-center justify-center border border-gray-600 rounded-full absolute top-8 right-8 h-8 w-8">
                  <IoClose
                ...
                <div className="">
                  <div className="left-side lg:w-5/12 bg-gray-200 rounded-lg px-10 py-14">
                    ...
                    <Menubar className="bg-none mt-4">
                      <MenubarMenu>
                        <MenubarTrigger>
                          <button className="w-full bg-white">Choose custom</button>
                        </MenubarTrigger>
                        <MenubarContent>
                          <MenubarItem>
