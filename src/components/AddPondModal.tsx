...
const AddPondModal = ({ open, setOpen }: any) => {
                ...
                <div className="bg-white lg:py-10 lg:px-14 p-10">
                  ...
                  <form className="space-y-4 mt-8">
                    ...
                    <div className="flex items-center justify-between space-x-6">
                      ...
                      <Button className=" mt-10 outline-none border-none font-normal text-xs bg-[--primary] hover:bg-[--secondary] w-full h-[53px] text-white">
                        Add Pond
                      </Button>
                    </div>
                  </form>
